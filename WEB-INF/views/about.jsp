				...
				<div class="row justify-content-center">
					<div class="col-lg-8 col-xxl-6">
						<div class="text-center my-5">
							...
							<b>football.com</b>에서 <b>축구</b>에 대한 <b>최신 뉴스 정보</b>와 <b>하이라이트 영상</b>, <br>
							인기 경기 <b>프리미어리그 경기 일정/순위/결과 확인</b>, 자유로운 분위기의 <b>커뮤니티</b>, 국내 최대 규모의 <b>굿즈샵</b>  <br>
							이 모든 것들을 <b>football.com</b>에서 한번에 경험해 보세요!
		...
		<section class="py-5 bg-light" id="scroll-target">
			<div class="container px-5 my-5">
				<div class="row gx-5 align-items-center">
					<div class="col-lg-6">
						<img class="img-fluid rounded mb-5 mb-lg-0"
							src="resources/img/news.jpg"
							width="350" alt="이미지" />
					</div>
					<div class="col-lg-6">
						<h2 class="fw-bolder">최신 축구 소식 &amp; 하이라이트</h2>
						<p class="lead fw-normal text-muted mb-0">
							어느 곳에서보다 빠르게 최신 축구 소식들을 접하고 <br>
							하이라이트 영상 까지 한눈에 살펴보세요!</p>
							<br>
						<a class="btn btn-primary btn-lg" href="${pageContext.request.contextPath }/highlightForm">뉴스/하이라이트 바로가기</a>
						<img class="img-fluid rounded mb-5 mb-lg-0"
			...
			<div class="container px-5 my-5">
				<div class="row gx-5 align-items-center">
					...
					<div class="col-lg-6">
						...
						<p class="lead fw-normal text-muted mb-0">
							전 세계 인기리그인 프리미어리그의<br>
							경기 결과와 일정 순위까지 확인해보세요</p>
							<br>
						<a class="btn btn-primary btn-lg" href="${pageContext.request.contextPath }/premierRanking">프리미어리그 경기정보 바로가기</a>
						<img class="img-fluid rounded mb-5 mb-lg-0"
							src="resources/img/target.png"
							width="50" alt="이미지" />
					</div>
				</div>
			</div>
			...
			<div class="container px-5 my-5">
				<div class="row gx-5 align-items-center">
					...
					<div class="col-lg-6">
						...
						<p class="lead fw-normal text-muted mb-0">
							축구를 사랑하고 좋아하는 다른 유저들과<br>
							자유롭게 의견을 나누고 공유해 보세요!</p>
							<br>
						<a class="btn btn-primary btn-lg" href="${pageContext.request.contextPath }/boardListForm">커뮤니티 게시판 바로가기</a>
						<img class="img-fluid rounded mb-5 mb-lg-0"
         ...
         <div class="container px-5 my-5">
            ...
            <div
               ...
               <div class="col mb-5 mb-5 mb-xl-0">
                  <div class="text-center">
                     <img class="img-fluid rounded-circle mb-4 px-4"
                        src="${pageContext.request.contextPath }/resources/img/seo.jpg"
