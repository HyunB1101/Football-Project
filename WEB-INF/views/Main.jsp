		...
		<div class="f-wrap"
			...
			<div class="aside left"
				...
				<div class="ranking" style="margin-bottom: 4rem;">
					<h2 class="campton"
						style="-swiper-theme-color: #007aff; - -swiper-navigation-size: 44px; margin: 0; border: 0; font: inherit; vertical-align: baseline; font-size: 1.2rem; font-weight: 800; padding: 0 0 1.2142857143rem; color: #222222;">팀
						순위</h2>
					<a href="${pageContext.request.contextPath }/premierRanking"
						class="btn-more size2 side-more">더보기<span class="icon"></span></a>
					<div class="box">
						<ul class="tab-btns low"
							style="padding: 0px; margin-bottom: 20px; padding-bottom: 20px;">
							<li class="eplbtn" style="float: left"><a class="eplbtn"
								type="button"> <img
									src="${pageContext.request.contextPath }/resources/img/premier league.jpg"
									style="height: 30px; width: 140px;" alt="EPL">
							</a></li>
							<li class="lligabtn" style="float: right"><a
								class="lligabtn" type="button"> <img
									src="${pageContext.request.contextPath }/resources/img/laliga.jpg"
									style="height: 30px; width: 100px;" alt="LALIGA">
							</a></li>
						</ul>
				...
				<div class="score" style="margin-bottom: 4rem;">
					...
					<div class="box"
						...
						<ul class="tab-btns low"
							style="padding: 0px; margin-bottom: 20px; padding-bottom: 20px;">
							<li class="active" style="float: left;"><span> <img
									src="${pageContext.request.contextPath }/resources/img/premier league.jpg"
									style="height: 30px; width: 140px;" alt="EPL">
							</span></li>
							<li class="active" style="float: right;"><span> <img
									src="${pageContext.request.contextPath }/resources/img/laliga.jpg"
									style="height: 30px; width: 100px;" alt="LALIGA">
							</span></li>
						</ul>
						...
						<div class="tab-con-wrap row">
							<div class="cont active">
								<ul class="gall f-wrap" id="news-all">
									<li class="l-box"><a
										href="https://sports.news.naver.com/news?oid=076&aid=0003978533 class="f-wrap"><div
												class="img-box" style="float: left;">
												<img
													src="https://imgnews.pstatic.net/image/076/2023/03/07/2023030801000472200047701_20230307083305867.jpg?type=w647"
													width="530px;" height="auto;">
											</div>
											<div class="txt-box" style="float: left;">
												<span class="sort">NEWS <br></span><strong class="name">맨유,
													케인 만났다! 협상 뒤 확신 "올 여름 잡는다"</strong><span class="s-txt">더 선
													캡처.[스포츠조선 한동훈 기자] 무성한 이적설 속에 드디어 실제 접촉이 이루어졌다. 맨체스터 유나이티드가
													해리 케인(토트넘 핫스퍼)을 영입 작업을 시..."</span>
											</div></a></li>
									<li><a
						...
						<div class="cont active">
								...
								<div class="f-wrap gall style2" id="highlightK1Main">
									<ul class="right f-wrap" id="highlightK1Sub">
										<li><a href="https://www.youtube.com/watch?v=lIR5HyC-C0M">
												...
												<div class="txt-box">
													<strong class="name">[22/23 UCL] 토트넘 vs 프랑크푸르트 손흥민
														활약상</strong>
													<div class="sort">
														<span>2022.10.29</span><span>조회수 4</span>
													</div>
												</div>
										</a></li>
										<li><a href="https://www.youtube.com/watch?v=hakHChindAE">
												...
												<div class="txt-box">
													<strong class="name"> [22/23 세리에A 18R] 나폴리 vs 유벤투스
														김민재 주요장면</strong>
													<div class="sort">
														<span>2022.10.26</span><span>조회수 3</span>
													</div>
												</div>
										</a></li>
										...
										<li><a href="https://www.youtube.com/watch?v=eHLoGpklFtY">
												...
												<div class="txt-box">
													<strong class="name">역천괴가 프리미어리그를 찢는 법｜엘링 홀란드
														22/23 시즌 활약상</strong>
													<div class="sort">
									...
									<a href="https://www.youtube.com/watch?v=popyj9Wg7bE"
										...
										<div class="txt-box">
											<strong class="name">로베르트 레반도프스키 22-23 라리가 활약상</strong>
											<div class="sort">
												<span>2022.11.02</span><span>조회수 8</span>
											</div>
										</div>
									</a>
								</div>
							...
							<div class="box" id="box" style="margin-bottom: 4rem;">
								...
								<ul class="gall style2 ea3 f-wrap" id="goalK1"
									style="height: 470px;">
									<li><a href="https://www.youtube.com/watch?v=qf97zip1T9U">
											<div class="img-box2">
												<img
									...
									<li><a href="https://www.youtube.com/watch?v=HXA7TkH1vEs">
											<div class="img-box2">
												<img
									...
									<li><a href="https://www.youtube.com/watch?v=WOww2jMyUjU">
											<div class="img-box2">
												<img
									...
									<li><a href="https://www.youtube.com/watch?v=bf3inlApvsY">
											<div class="img-box2">
												<img
